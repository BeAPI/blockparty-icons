...
if ! grep -qF "define( 'BLOCKPARTY_ICONS_VERSION', '$NEW_VER' );" blockparty-icons.php; then
	echo "::error::blockparty-icons.php define BLOCKPARTY_ICONS_VERSION must be '${NEW_VER}'"
	fail=1
fi
